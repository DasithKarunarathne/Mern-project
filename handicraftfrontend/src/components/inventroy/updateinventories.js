...
export default function UpdateInventories() {
    ...
    const [formData, setFormData] = useState({
        ...
        itemname: "",
        price: "",
        quantity: "", // Correct field name for quantity
        description: "",
        inventorydate: "",
    });
    ...
    const fetchItemData = async () => {
        ...
        try {
            ...
            setFormData({
                ...
                quantity: inventory.qty, // Fixed: Correctly map `qty` to `quantity`
        ...
        try {
            const response = await fetch(`http://localhost:5000/inventory/update/${id}`, {
                ...
                body: JSON.stringify({
                    ...
                    qty: parseInt(formData.quantity, 10), // Fixed: Correctly map `quantity` to `qty`
